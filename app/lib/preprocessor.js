  ...
  if (copy.paths) {
    Object.keys(copy.paths).forEach(function(pathName) {
      ...
      Object.keys(path).forEach(function(method) {
        ...
        // operations can be a single or an array
        var operations = path[method]
        ...
        operations.forEach(operation => {
          ...
          operationTags.forEach(function(tag) {
            var tagDefinition = tagsByName[tag];
            if (!tagDefinition) {
            ...
            if (!tagDefinition.operations) {
              tagDefinition.operations = [];
            }
            tagDefinition.operations.push(operation);
          });
